...
public class AppTest 
{
    ...
    public void setup() {
        ...
        ExtentSparkReporter spark = new ExtentSparkReporter(
                "C:\\Users\\Acer\\Downloads\\cc2softwaretesting\\cc2softwaretesting\\src\\report\\report.html");
        reports.attachReporter(spark);
        test = reports.createTest("Demo Result");
        WebDriverManager.chromedriver().setup();
        driver = new ChromeDriver();
        PropertyConfigurator.configure("C:\\Users\\Acer\\Downloads\\cc2softwaretesting\\cc2softwaretesting\\src\\test\\java\\com\\resources\\log4j.properties");
    }
    @BeforeMethod
    ...
    public void testCase1() throws IOException, InterruptedException {
        ...
        FileInputStream fs = new FileInputStream("C:\\Users\\Acer\\Downloads\\cc2softwaretesting\\cc2softwaretesting\\src\\Excel\\websites.xlsx");
